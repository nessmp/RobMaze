...
{
  int pos = MPUY();
  int CountEnc = const90 / 90;
  bool Listo = false;

  do {
    if (pos > 90 && pos < 135)
    {
      int New = (pos - 90) * CountEnc;
      EncDerE.write(0);
      while (Encoder1() < New)
      {
        Izquierda();
