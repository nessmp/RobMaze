...
byte const PROGMEM CalibCalor = 50;
...
byte const PROGMEM velMDE = 168;
byte const PROGMEM velMDA = 168;
byte const PROGMEM velMIE = 153;
byte const PROGMEM velMIA = 147;
byte Dif = 0;
...
void Detectar()
{
  ...
  //byte Therm4 = therm4.object(); //Derecha
...
void loop() {
  ...
  Serial.print("\t");
  Serial.print("paso ");
  Serial.print(Pos[1][20][20]);
  Serial.print("\t");
  Serial.print("Posibilidades: ");
  Serial.println(Possibility[1]);
  for(byte iI = 0; iI < 4; iI++)
  {
    ...
    Serial.print(iI);
    Serial.print("] ");
    Serial.println(Run[Pos[1][20][20]][iI]);
  }
  Serial.println(".................................");
  Serial.print("11920");
  Serial.print("\t");
  Serial.print("paso ");
  Serial.print(Pos[1][19][20]);
  Serial.print("\t");
  Serial.print("Posibilidades: ");
  Serial.println(Possibility[2]);
  for(byte iI = 0; iI < 4; iI++)
  {
    Serial.print("Run[ ");
    Serial.print(Pos[1][19][20]);
    ...
    Serial.print(iI);
    Serial.print("] ");
    Serial.println(Run[Pos[1][19][20]][iI]);
  }
  Serial.println(".................................");
  Serial.print("01919");
  Serial.print("\t");
  Serial.print("paso ");
  Serial.print(Pos[0][19][19]);
  Serial.print("\t");
  Serial.print("Posibilidades: ");
  Serial.println(Possibility[3]);
  for(byte iI = 0; iI < 4; iI++)
  {
    Serial.print("Run[ ");
    Serial.print(Pos[0][19][19]);
    ...
    Serial.print(iI);
    Serial.print("] ");
    Serial.println(Run[Pos[0][19][19]][iI]);
  }
  Serial.println(".................................");
  Serial.print("02019");
  Serial.print("\t");
  Serial.print("paso ");
  Serial.print(Pos[0][20][19]);
  Serial.print("\t");
  Serial.print("Posibilidades: ");
  Serial.println(Possibility[4]);
  for(byte iI = 0; iI < 4; iI++)
  {
    Serial.print("Run[ ");
    Serial.print(Pos[0][20][19]);
    ...
    Serial.print(iI);
    Serial.print("] ");
    Serial.println(Run[Pos[0][20][19]][iI]);
  }
  Serial.println(".................................");
  Serial.print("12019");
  Serial.print("\t");
  Serial.print("paso ");
  Serial.print(Pos[1][20][19]);
  Serial.print("\t");
  Serial.print("Posibilidades: ");
  Serial.println(Possibility[5]);
  for(byte iI = 0; iI < 4; iI++)
  {
    Serial.print("Run[ ");
    Serial.print(Pos[1][20][19]);
    ...
    Serial.print(iI);
    Serial.print("] ");
    Serial.println(Run[Pos[1][20][19]][iI]);
  }
  Serial.println(".................................");
  */
